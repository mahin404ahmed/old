...
channel_link = "https://www.facebook.com/mahtim.mahir404"
 
# Valid keys (channel par available hogi)
approved_keys = ["MR. MAHIN"]
...
def first_step():
    ...
    print("        🔒 Script Locked 🔒")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
    print("\033[1;32m CREATE BY MAHIN ✅ \033[0m\n")
    print("\033[1;32m KEY PETE FB ID TE MSG DEN✅ \033[0m\n")
    print("[!] MY FB IDo.")
...
os.system('clear')
os.system('xdg-open https://www.facebook.com/mahtim.mahir404')
os.system('xdg-open https://www.facebook.com/mahtim.mahir404')
